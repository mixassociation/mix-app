...
class CryptorusItem extends skynode_1.DomNode {
    constructor(tab, id) {
        ...
        this.append((0, skynode_1.el)(".content", this.cryptorus = (0, skynode_1.el)(".cryptorus", (0, skynode_1.el)("span.id", `#${id}`)), (0, skynode_1.el)(".info", (0, skynode_1.el)("h5", "쌓인 MIX"), this.mixAmount = (0, skynode_1.el)(".amount", "Loading...")), (0, skynode_1.el)(".controller", (0, skynode_1.el)("button.claim-button", "받기", {
            click: async () => {
    ...
    async loadImage() {
        ...
        this.cryptorus.style({ backgroundImage: `url(${metadata.image})` });
    }
    async load() {
