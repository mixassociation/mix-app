...
class Proposal extends skynode_1.DomNode {
    constructor(proposal) {
        ...
        this.append((0, skynode_1.el)("h5", proposal.title), (0, skynode_1.el)(".status", proposal.rejected == true ? "기각" : (proposal.passed == true ? (proposal.passTime + Constants_1.default.VOTE_PERIOD - Date.now() < 0 ? "투표 종료" : "투표중") : "검토중")));
        this.onDom("click", () => {
