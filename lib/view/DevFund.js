...
class DevFund {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".devfund-view", (0, skynode_1.el)("h1", "개발 펀드"), (0, skynode_1.el)(".text-container", "* 예치 시에는 2번의 트랜잭션이 발생합니다. 한번은 토큰 사용 허락을 위한 것이며, 다른 하나는 실제 예치를 위한 것입니다."), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "MIX 수령하기"), (0, skynode_1.el)(".balance", (0, skynode_1.el)("span", "쌓인 MIX: "), this.claimableDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("button", "수령하기", {
            click: async () => {
                await DevFundPoolContract_1.default.claim();
                ViewUtil_1.default.waitTransactionAndRefresh();
            },
        })), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "Dev Fund Token 예치하기"), this.stakeInput = (0, skynode_1.el)("input", { placeholder: '예치할 액수를 넣어주세요.' }), (0, skynode_1.el)(".info", (0, skynode_1.el)(".balance", (0, skynode_1.el)("span", "Dev Fund Token: "), this.balanceDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("a", "최대 수량 입력", {
            click: async () => {
        ...
        })), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "Dev Fund Token 출금하기"), this.unstakeInput = (0, skynode_1.el)("input", { placeholder: '출금할 액수를 넣어주세요.' }), (0, skynode_1.el)(".info", (0, skynode_1.el)(".balance", (0, skynode_1.el)("span", "Staked: "), this.stakedDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("a", "최대 수량 입력", {
            click: async () => {
                const walletAddress = await Wallet_1.default.loadAddress();
                if (walletAddress !== undefined) {
