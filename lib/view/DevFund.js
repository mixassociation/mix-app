...
class DevFund {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".devfund-view", (0, skynode_1.el)("h1", "개발 펀드"), (0, skynode_1.el)("section", (0, skynode_1.el)("h2", "MIX 수령하기"), (0, skynode_1.el)(".balance", (0, skynode_1.el)("span", "쌓인 MIX: "), this.claimableDisplay = (0, skynode_1.el)("span", new Loading_1.default())), (0, skynode_1.el)("button", "수령하기", {
            click: async () => {
