...
class Proposal {
    ...
    async load(proposalId) {
        ...
        contentDisplay.domElement.innerHTML = (0, xss_1.default)((0, marked_1.default)(proposal.content.replace(/\n/g, "<br>")));
        noteDisplay.domElement.innerHTML = (0, xss_1.default)((0, marked_1.default)(proposal.note.replace(/\n/g, "<br>")));
