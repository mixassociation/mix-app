...
class RemoveMates {
    constructor(params) {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".add-mates-to-turntable-view", (0, skynode_1.el)("h1", "턴테이블에 메이트 등록 취소하기"), (0, skynode_1.el)("p", "해당 턴테이블에서 더 이상 리스너로 등록되지 않을 메이트를 선택해주시기 바랍니다."), this.selectedMates = (0, skynode_1.el)(".selected-mates", "선택된 메이트 갯수 : {count}개".replace(/{count}/, String(0))), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("a", "▶ 최대로 선택하기", {
            click: () => this.mateList.maxSelect(),
        })), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("a", "▶ 전체 선택 해제", {
            click: () => this.mateList.deselect(),
        })), this.mateList = new MateList_1.default(true, false), (0, skynode_1.el)("button.submit-button", "메이트 등록 취소", {
            click: async () => {
