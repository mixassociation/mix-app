...
class BurnPool {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".burnpool-view", (0, skynode_1.el)("h1", "소각 풀"), (0, skynode_1.el)("section", (0, skynode_1.el)(".balance", (0, skynode_1.el)("span", "쌓인 MIX: "), this.burnableDisplay = (0, skynode_1.el)("span.mix", new Loading_1.default())), (0, skynode_1.el)("button", "소각하기", {
            click: async () => {
